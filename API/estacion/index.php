...
<div class="row ">
    <div class="col-12 page-header">
        ...
        <h1 class="center">Prueba de redirección Estaciones </h1>
    </div>
</div>
<div class="row">
...
<div class="col-md-6 .md-auto">
    <p>
        <a href="#" onClick="window.open('http://emecubo.extremepromotionsproject.xyz/API/estacion/lista','popup', 'width=400px,height=400px')">
            Pulsar para ver un popup con la lista de estaciones 
        </a> o selecciona una del desplegable siguiente:
    </p>
    <?php
        ...
        echo "<div class='form-group'>";
            ...
            echo "<option value='lista'>estaciones</option>";
