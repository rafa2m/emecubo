...
<?php
    ...
    $sql= "insert into mensajes (titulo,mensaje,imagen_url,enviado) values('".$titulo."','".$mensaje."','https://pwa.desarrollando-web.es/adminNotificaciones/user_images/".$userpic."','0')";
    ...
    if ($result_cont ==1){
      ...
      function lee(){
       ...
       $.ajax({
          url: 'https://pwa.desarrollando-web.es/adminNotificaciones/send.php?titulo=<?php echo $titulo;?>&cuerpo=<?php echo $mensaje;?>&icono=https://pwa.desarrollando-web.es/adminNotificaciones/user_images/<?php echo $userpic;?>&image=https://pwa.desarrollando-web.es/adminNotificaciones/user_images/<?php echo $userpic;?>',
          method: 'POST'
      ...
      <?php
        ...
        //header("location: ../adminNotificaciones/adminPush.php?er=7");
